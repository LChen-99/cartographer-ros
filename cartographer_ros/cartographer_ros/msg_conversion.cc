  ...
  for (size_t i = 0; i < msg.ranges.size(); ++i) {
    ...
    if (HasEcho(echoes)) {
      ...
      if (msg.range_min <= first_echo && first_echo <= msg.range_max) {
        ...
        // test_lc
        // std::cout << "TimedRangefinderPoint.x = " <<  point.position[0] << std::endl;
        // std::cout << "TimedRangefinderPoint.x = " <<  point.position[1] << std::endl;
        // std::cout << "TimedRangefinderPoint.z = " <<  point.position[2] << std::endl;
